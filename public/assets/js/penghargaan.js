document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        const detailFields = [
            'pegawai', 'kegiatan', 'nama_penghargaan', 'nomor', 'tanggal_perolehan',
            'lingkup', 'negara', 'instansi', 'jenis_dokumen', 'nama_dokumen',
            'nomor_dokumen', 'tautan'
        ];
