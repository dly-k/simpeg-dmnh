...
class PensiunExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithTitle, WithEvents
{
    protected $pegawai;
    protected $search;
    protected $tahun;
    ...
    {
        return Pensiun::where('pegawai_id', $this->pegawai->id)
            ...
            ->orderBy('tmt_pensiun', 'desc')
            ->get();
    }

    public function headings(): array
    {
        return ['No', 'Jenis Pensiun', 'Nomor SK', 'Tanggal SK', 'TMT Pensiun', 'Link Berkas'];
    }
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            Carbon::parse($row->tmt_pensiun)->isoFormat('D MMMM YYYY'),
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'RIWAYAT PENSIUN - ' . strtoupper($this->pegawai->nama_lengkap));
