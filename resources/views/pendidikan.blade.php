  ...
  <style>
    * {
    ...
    .main {
      ...
      overflow-y: hidden; /* Hapus scroll dari sini */
    }
    ...
    .title-bar {
      ...
      color: white;
      padding: 20px 30px;
      flex-shrink: 0; /* Mencegah title bar menyusut */
    }
    ...
    .content-area {
      padding: 30px;
      flex-grow: 1;
      overflow-y: auto; /* Tambahkan scroll hanya di sini */
    }
...
<body>
  <div class="layout">
    ...
    <div class="sidebar">
      ...
      <ul>
          ...
          <ul style="margin-left: 20px;">
              <li><a href="/pendidikan" class="menu-item active-sub">🎓 Pendidikan</a></li>
    ...
    <div class="main">
      ...
      <div class="title-bar">
        <h1><i class="fa fa-edit"></i> Editor Kegiatan - Pendidikan</h1>
      </div>
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <div class="d-flex gap-2 flex-wrap">
                    <select class="form-select" style="width: auto;"><option selected>Semester</option><option>Genap 2024/2025</option></select>
                    <select class="form-select" style="width: auto;"><option selected>Status</option><option>Terverifikasi</option><option>Ditolak</option></select>
