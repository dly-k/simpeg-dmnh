  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="penunjangModalLabel">
          <i class="fas fa-plus-circle"></i> Tambah Data Penunjang
        </h5>
        ...
        <form id="penunjangForm">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" placeholder="Masukkan Jenis Kegiatan" required>
            </div>

            <div class="col-12">
              <label class="form-label">Lingkup</label>
              <input type="text" class="form-control" placeholder="Masukkan Lingkup Kegiatan" required>
            </div>
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" placeholder="Masukkan Nama Instansi" required>
            </div>
            ...
            <div class="col-md-6">
              <label class="form-label">Terhitung Sampai Tanggal</label>
              <input type="date" class="form-control" required>
            </div>
