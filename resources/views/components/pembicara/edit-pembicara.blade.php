<div class="modal fade" id="editPembicaraModal" tabindex="-1" aria-labelledby="modalTitleEdit" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <form id="editPembicaraForm" action="#" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <select name="kegiatan" id="edit_kegiatan" class="form-select">
                ...
                <option value="jadwal_internasional">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat: Terjadwal/Terprogram, kurang dari 1 semester (≥1 bulan), Tingkat Internasional</option>
                <option value="insidental">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat: Insidental (tiap kegiatan/program)</option>
                <option value="insidental_nasional">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat: Insidental, Tingkat Nasional</option>
                <option value="insidental_lokal">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat: Insidental, Tingkat Lokal</option>
                <option value="insidental_internasional">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat: Insidental, Tingkat Internasional</option>
                <option value="jadwal_nasional_semester">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat: Terjadwal/Terprogram, ≥1 semester, Tingkat Nasional</option>
                <option value="jadwal_lokal_semester">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat: Terjadwal/Terprogram, ≥1 semester, Tingkat Lokal</option>
                <option value="jadwal_internasional_semester">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat: Terjadwal/Terprogram, ≥1 semester, Tingkat Internasional</option>
                <option value="lainnya">Lainnya</option>
              </select>
              <input type="text" name="kegiatan_lainnya" id="edit_kegiatan_lainnya" class="form-control mt-2 d-none" placeholder="Tulis kegiatan lainnya">
            </div>
            ...
            <div class="col-12">
              ...
              <input type="text" name="kategori_capaian_lainnya" id="edit_kategori_capaian_lainnya" class="form-control mt-2 d-none" placeholder="Tulis capaian lainnya">
            </div>
