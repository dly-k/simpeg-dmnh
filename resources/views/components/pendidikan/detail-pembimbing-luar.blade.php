      ...
      <div class="modal-body">
        ...
        <div class="detail-grid-container">
          <div class="detail-item full-width-detail">
            ...
            <p id="detail_pbl_luar_kegiatan">-</p>
          </div>
          ...
          <div class="detail-item">
            <small>NIM</small>
            <p id="detail_pbl_luar_nim">-</p>
          </div>
          <div class="detail-item">
            <small>Nama Mahasiswa</small>
            <p id="detail_pbl_luar_nama_mahasiswa">-</p>
          </div>
          <div class="detail-item">
            <small>Universitas</small>
            <p id="detail_pbl_luar_universitas">-</p>
          </div>
          <div class="detail-item">
            <small>Program Studi</small>
            <p id="detail_pbl_luar_program_studi">-</p>
          </div>
          <div class="detail-item">
            <small>Insidental</small>
            <p id="detail_pbl_luar_insidental">-</p>
          </div>
          <div class="detail-item">
            <small>Lebih Dari 1 Semester</small>
            <p id="detail_pbl_luar_lebih_satu_semester">-</p>
          </div>
        </div>
        ...
        <div class="document-viewer-container">
          <embed 
            id="detail_pbl_luar_document_viewer" 
            src="" 
