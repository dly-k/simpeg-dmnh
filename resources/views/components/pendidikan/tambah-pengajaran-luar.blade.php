      ...
      <div class="modal-body">
        <form id="formPengajaranLuar" onsubmit="return false;">
          ...
          <div class="mb-3">
            ...
            <div class="row">
              <div class="col-md-6"><input type="number" class="form-control" id="pl_sks_kuliah" name="sks_kuliah" placeholder="Perkuliahan"></div>
              <div class="col-md-6"><input type="number" class="form-control" id="pl_sks_praktikum" name="sks_praktikum" placeholder="Praktikum"></div>
            </div>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="pl_jenis" name="jenis"><option selected disabled value="">-- Pilih --</option><option value="K">Kuliah</option><option value="P">Praktikum</option></select>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <select class="form-select" id="pl_is_insidental" name="is_insidental"><option selected disabled value="">-- Pilih --</option><option value="Ya">Ya</option><option value="Tidak">Tidak</option></select>
            </div>
            <div class="col-md-6">
              <label for="pl_is_lebih_satu_semester" class="form-label">Lebih Dari 1 Semester</label>
              <select class="form-select" id="pl_is_lebih_satu_semester" name="is_lebih_satu_semester"><option selected disabled value="">-- Pilih --</option><option value="Ya">Ya</option><option value="Tidak">Tidak</option></select>
            </div>
          </div>
          <div class="mb-3">
