            ...
            <div class="modal-body">
                <form id="penelitianForm">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6"><label class="form-label">Jumlah Halaman</label><input type="number" class="form-control" name="jumlahHalaman" placeholder="Contoh: 10"></div>
                        ...
                        <div class="col-md-6"><label class="form-label">URL</label><input type="text" class="form-control" name="url" placeholder="https://example.com"></div>
