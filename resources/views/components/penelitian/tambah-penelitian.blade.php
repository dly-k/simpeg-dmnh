<div class="modal fade" id="penelitianModal" tabindex="-1" aria-labelledby="penelitianModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
        ...
        <form id="penelitianForm" action="{{ route('penelitian.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="number" class="form-control" name="jumlah_halaman" placeholder="Contoh: 10">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12 mt-4">
              <h6 class="border-bottom pb-2">Data Penulis</h6>
            </div>
            <div class="col-12">
              <label class="form-label">Penulis Internal (Pegawai)</label>
              <div id="penulis-ipb-list"></div>
            </div>
            <div class="col-12">
              <label class="form-label">Penulis Luar</label>
      ...
      <!-- FOOTER (di luar form, tetap bisa submit) -->
      <div class="modal-footer mt-3">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
        <button type="submit" class="btn btn-success" form="penelitianForm">Simpan</button>
      </div>
