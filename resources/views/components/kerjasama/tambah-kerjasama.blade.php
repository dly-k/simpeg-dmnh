{{-- MODIFIED: tambah-kerjasama.blade.php --}}
      ...
      <div class="modal-body">
        <form id="kerjasamaForm">
          <div class="row g-3">
            ...
            {{-- START PERUBAHAN: Nomor Dokumen dipecah --}}
            <div class="col-md-6"><label class="form-label">No Surat Mitra</label><input type="text" class="form-control" name="no_surat_mitra" placeholder="Nomor Dokumen dari Mitra"></div>
            <div class="col-md-6"><label class="form-label">No Surat Departemen</label><input type="text" class="form-control" name="no_surat_departemen" placeholder="Nomor Dokumen dari Departemen"></div>
            {{-- END PERUBAHAN --}}
            ...
            {{-- START PERUBAHAN: Input Ketua Tim (Dinamis) --}}
            <div class="col-12">
              <label class="form-label">Ketua Tim</label>
              <div id="ketua-list">
                {{-- JavaScript akan menambahkan input ketua di sini --}}
              </div>
              <button type="button" class="btn btn-sm btn-outline-primary mt-2" id="add-ketua-btn">+ Tambah Ketua</button>
            </div>
            {{-- END PERUBAHAN --}}

            {{-- START PERUBAHAN: Input Anggota Tim (Dinamis dengan Departemen) --}}
            <div class="col-12">
              <label class="form-label">Anggota Tim (jika ada)</label>
              <div id="anggota-list">
                {{-- JavaScript akan menambahkan input anggota di sini --}}
              </div>
            ...
            <div class="col-md-6"><label class="form-label">Jenis Kerjasama</label><select class="form-select" name="jenis"><option selected>-- Pilih Salah Satu --</option><option>MoU</option><option>LoA</option><option>SPK</option></select></div>

            {{-- START PERUBAHAN: Tambah input Jenis Usulan --}}
            <div class="col-md-6"><label class="form-label">Jenis Usulan</label><select class="form-select" name="jenis_usulan"><option selected>-- Pilih Salah Satu --</option><option>Baru</option><option>Perpanjangan</option></select></div>
            {{-- END PERUBAHAN --}}
            ...
            {{-- START PERUBAHAN: Tambah input Laporan Kerjasama --}}
            <div class="col-12">
