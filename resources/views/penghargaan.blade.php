...
<body>
  <div class="layout">
    ...
    <div class="sidebar">
      ...
      <ul>
          ...
          <ul style="margin-left: 20px;">
              ...
              <li><a href="/penghargaan" class="menu-item active-sub">🏅 Penghargaan</a></li>
    ...
    <div class="main">
      ...
      <div class="title-bar">
        <h1><i class="fa fa-edit"></i> Editor Kegiatan - Penghargaan</h1>
      </div>
        ...
        <div class="card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <div class="d-flex gap-2 flex-wrap">
                    <select class="form-select" style="width: auto;"><option selected>Tahun</option><option>2023</option></select>
