...
<head>
  ...
  <title>SIKEMAH - Editor Kegiatan (Pembimbingan)</title>
    ...
    <div class="main-wrapper">
      ...
      <div class="title-bar">
        <h1>
          ...
          <span id="page-title">Editor Kegiatan - Pembimbingan</span>
        </h1>
      </div>
        ...
        <div class="card">
          <div class="card-body p-4">
            ...
            <div class="d-flex flex-wrap align-items-center mb-3 gap-2">
              ...
              <div class="ms-auto">
                <button class="btn btn-tambah fw-bold" data-bs-toggle="modal" data-bs-target="#tambahPembimbinganModal">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered align-middle">
                ...
                <tbody class="text-center">
                  <tr>
                    <td>1</td>
                    <td class="text-start">Pembimbingan Skripsi</td>
                    <td>2024 / Genap</td>
                    <td>SK-2024-001</td>
                    <td>
                    ...
                    <td class="text-center">
                      <div class="d-flex justify-content-center gap-2">
                        ...
                        <button 
                          ...
                          data-bs-target="#editPembimbinganModal">
                  ...
                  <tr>
                    <td>2</td>
                    <td class="text-start">Pembimbingan KKN</td>
                    <td>2023 / Ganjil</td>
                    <td>SK-2023-015</td>
                    <td>
