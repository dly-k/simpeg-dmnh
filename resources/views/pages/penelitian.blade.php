            ...
            <div class="search-filter-container">
              <div class="search-filter-row">
                ...
                <div class="btn-tambah-container">
                  <a href="{{ route('penelitian.export', request()->all()) }}" class="btn btn-export fw-bold">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered">
                ...
                <tbody id="penelitian-table-body">
                  ...
                  <tr data-row-id="{{ $item->id }}">
                    ...
                    <td class="text-center">
                      <div class="d-flex gap-2 justify-content-center">
                        ...
                        <a href="#" class="btn-aksi btn-edit" title="Edit Data" onclick="event.preventDefault(); openEditModal({{ $item->id }})">
                  ...
                  @empty
                  <tr>
                    <td colspan="8" class="text-center text-muted">Data Penelitian belum tersedia</td>
                  </tr>
                  @endforelse
                </tbody>
              </table>
