                ...
                <div class="tab-bar-container">
                    <ul class="nav nav-pills" id="pegawaiTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pegawai-aktif-tab" data-bs-toggle="tab" data-bs-target="#pegawai-aktif" type="button" role="tab" aria-controls="pegawai-aktif" aria-selected="true">Pegawai Aktif</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="riwayat-pegawai-tab" data-bs-toggle="tab" data-bs-target="#riwayat-pegawai" type="button" role="tab" aria-controls="riwayat-pegawai" aria-selected="false">Riwayat Pegawai</button>
                        </li>
                    </ul>
                    <div>
                                ...
                                <tbody>
                                    <script>
                                        const dataAktif = [
                                            ...
                                            { name: 'Dr. Budi Santoso, M.Kom', nip: '198205102006041001', status_kepegawaian: 'Dosen Tetap', jabatan_fungsional: 'Lektor', jabatan_struktural: 'Koordinator Prodi', pangkat: 'Penata / III-c', status_pegawai: 'Aktif' },
                                        ];
                                        dataAktif.forEach((item, index) => {
                                            document.write(`
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="badge text-bg-success">${item.status_pegawai}</span></td>
                        ...
                        <div class="table-responsive mt-4">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    <script>
                                        const dataRiwayat = [
                                            { name: 'Joko Anwar S.pd', nip: '194909061979031001', status_kepegawaian: 'Dosen tetap', jabatan_struktural: 'Ketua Departemen', pangkat: 'Penata Muda / III-a', status_pegawai: 'Meninggal' },
                                            { name: 'Ria Kodariah, S.Si', nip: '198103152005012001', status_kepegawaian: 'Tendik Tetap', jabatan_struktural: 'Staf Administrasi', pangkat: 'Pengatur / II-c', status_pegawai: 'Pensiun' },
                                            { name: 'Meli Surnami', nip: '198505202015042001', status_kepegawaian: 'Tendik Tetap', jabatan_struktural: 'Staf Keuangan', pangkat: 'Penata Muda / III-a', status_pegawai: 'Nonaktif' },
                                        ];
